<?php
/**
 * Entity insertion page for BikeStores site employees.
 *
 * Allows employees to dynamically add a product, brand, category, stock, or store via an interactive form.
