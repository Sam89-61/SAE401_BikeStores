<?php
/**
 * Chef employee account management page for the BikeStores website.
 *
 * Allows Chef employees to view and update their personal information (username, email, password).
    ...
    $(document).ready(function() {
        ...
        if(modif){
            modif.addEventListener("click", function() {
                $.ajax({
                    url: `https://bikestoresab.alwaysdata.net/bikestores/api.php?actionPut=udapteConnexE&id=${id}&name=${$("#username").val()}&email=${$("#email").val()}&password=${$("#password").val()}&KEY=e8f1997c763`,
                    type: "PUT",
