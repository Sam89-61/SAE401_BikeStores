        ...
        $(document).ready(function() {
            ...
            $(".choix-btn").click(function() {
                ...
                if (valeur == "") {
                    ...
                    $.ajax({
                        url: `https://bikestoresab.alwaysdata.net/bikestores/store/${<?php echo $_SESSION['StoreEmployee']; ?>}`,
                        type: "GET",
                        dataType: "json",
                        success: function(data) {
                            console.log(data);
                            ...
                            <tr>
                                ...
                                <td><a href='index.php?action=updateIT&modif=store&id=${data[0].store_id}'>Update</a></td>
                                <td><a href='index.php?action=deleteIT&sup=store&id=${data[0].store_id}'>Delete</a></td>
                            </tr>
                        `);
                        },
                        error: function(xhr, status, error) {
